function [OptionsStruct, OptFeatures, DatesClean, LongestMaturity] = SelectOptionsFilt(Dates, Type, ...
...
% Select MinimumPrice
    ...
    Selected = (Selected & (MeanOptionPrice>=3/8));

% Select MinimumOpenInterest
