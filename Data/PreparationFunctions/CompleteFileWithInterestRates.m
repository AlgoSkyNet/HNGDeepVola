...
load('interestRates2001to032020.mat');
data(5:8,:) = NaN;
...
save('SP500_date_prices_returns_realizedvariance_interestRates_090320.mat', 'SP500_date_prices_returns_realizedvariance_interestRates');