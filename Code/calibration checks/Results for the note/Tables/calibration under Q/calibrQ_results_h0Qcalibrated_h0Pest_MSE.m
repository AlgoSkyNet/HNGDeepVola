...
for cur_num = 1:num_years
    load(['data for tables/results calibration h0Calibrated esth0P/MSE/params_options_', year_nums{cur_num}, '_h0_calibrated_MSE_interiorpoint_noYield.mat']);
...
FID = fopen('calibrationQ_results_h0calibrated_h0Pest_calls_MSE_2010_2018.tex', 'w');
...
fprintf(FID, '\\toprule \n');
fprintf(FID, '\\multicolumn{10}{c}{{\\bf CALIBRATED PARAMETERS ON WEDNESDAYS, $h_0^Q$ IS CALIBRATED WITH RESPECT TO MSE}} \\\\\n');
fprintf(FID, '\\midrule \n');
