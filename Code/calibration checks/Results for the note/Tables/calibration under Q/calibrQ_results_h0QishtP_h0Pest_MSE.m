...
for cur_num = 1:num_years
    load(['data for tables/results calibration hoashtMLEP esthoP/MSE/params_options_', year_nums{cur_num}, '_h0ashtMLEP_MSE_interiorpoint_noYield_m.mat']);
...
FID = fopen('calibrationQ_results_h0QishtP_h0Pest_calls_MSE_2010_2018.tex', 'w');
...
fprintf(FID, '\\toprule \n');
fprintf(FID, '\\multicolumn{10}{c}{{\\bf CALIBRATED PARAMETERS ON WEDNESDAYS USING MSE, $h_0^Q = h_t^P$}} \\\\\n');
fprintf(FID, '\\midrule \n');
