...
for cur_num = 1:num_years
    load(['data for tables/results calibration hoasrelvola esthoP mp 1 day/OptLL/params_options_', year_nums{cur_num}, '_h0asRealVola6days_OptLL_interiorpoint_noYield.mat']);
