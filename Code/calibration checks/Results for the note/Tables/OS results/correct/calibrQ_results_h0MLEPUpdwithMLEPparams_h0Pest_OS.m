...
for cur_num = 1:num_years
    load(['data for tables/h0MLEPht/update Q with MLEP params/OS OptLL/params_options_', year_nums{cur_num}, '_h0_MLEP_UpdWithMLEPparams.mat']);
...
FID = fopen('calibrQ_results_h0MLEPUpdwithMLEPparams_h0Pest_calls_OS_10_18.tex', 'w');
...
fprintf(FID, '\\toprule \n');
fprintf(FID, '\\multicolumn{10}{c}{{\\bf NO CALIBRATION, $h_0^Q$ IS LAST MLEP, THEN 1 WEEK UPDATED UNDER Q WITH MLE P PARAMS}} \\\\\n');
fprintf(FID, '\\midrule \n');
