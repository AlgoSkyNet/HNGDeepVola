...
for cur_num = 1:num_years
    %load(['data for tables/h0UncVarUpdateQ/no update/OS OptLL/params_options_', year_nums{cur_num}, '_h0_uncVarUpdQ1year_noUpd.mat']);
    %load(['data for tables/h0calibrated/no update/OS OptLL/params_options_', year_nums{cur_num}, '_h0_calibr_noUpd.mat']);
    load(['data for tables/h0MLEPht/no update/OS OptLL/params_options_', year_nums{cur_num}, '_h0_MLEP_noUpd.mat']);
...
%FID = fopen('calibrQ_results_h0calNoUpd_h0Pest_calls_OS_10_18.tex', 'w');
FID = fopen('calibrQ_results_h0MLEPNoUpd_h0Pest_calls_OS_10_18.tex', 'w');
...
fprintf(FID, '\\toprule \n');
%fprintf(FID, '\\multicolumn{10}{c}{{\\bf  $h_0^Q$ IS UNC UNDER P, UPDATED UNDER Q 1 YEAR, THEN FROZEN}} \\\\\n');
fprintf(FID, '\\multicolumn{10}{c}{{\\bf  $h_0^Q=h_t^P$, THEN FROZEN}} \\\\\n');
fprintf(FID, '\\midrule \n');
