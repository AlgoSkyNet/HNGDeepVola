...
for cur_num = 1:num_years
    load(['data for tables/h0calibrated/update Q/OS OptLL/params_options_', year_nums{cur_num}, '_h0_calibr_Upd.mat']);
...
FID = fopen('calibrQ_results_h0calUpdQ_h0Pest_calls_OS_10_18.tex', 'w');
...
fprintf(FID, '\\toprule \n');
fprintf(FID, '\\multicolumn{10}{c}{{\\bf CALIBRATED PARAMETERS AND $h_0^Q$ ON WEDNESDAYS, 1 WEEK UPDATE UNDER Q}} \\\\\n');
fprintf(FID, '\\midrule \n');
