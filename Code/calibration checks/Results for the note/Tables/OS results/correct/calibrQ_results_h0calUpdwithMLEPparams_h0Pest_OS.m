...
for cur_num = 1:num_years
    load(['data for tables/h0calibrated/update Q with MLEP params/OS OptLL/params_options_', year_nums{cur_num}, '_h0_calibr_UpdWithMLEPparams.mat']);
...
FID = fopen('calibrQ_results_h0calUpdwithMLEPparams_h0Pest_calls_OS_10_18.tex', 'w');
...
fprintf(FID, '\\toprule \n');
fprintf(FID, '\\multicolumn{10}{c}{{\\bf ONLY $h_0^Q$ IS CALIBRATED, THEN 1 WEEK UPDATED UNDER Q WITH MLEP PARAMS}} \\\\\n');
fprintf(FID, '\\midrule \n');
