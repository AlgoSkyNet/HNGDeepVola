...
for cur_num = 1:num_years
    load(['data for tables/calibrated h0 no update/params_options_', year_nums{cur_num}, '_h0_calibrated_noUpd_noYield.mat']);
...
FID = fopen('calibrQ_results_h0calibrNoUpd_h0Pest_calls_OS_10_18.tex', 'w');
