...
for cur_num = 1:num_years
    load(['data for tables/h0MLEPht/update Q/OS OptLL/params_options_', year_nums{cur_num}, '_h0_MLEP_Upd.mat']);
...
FID = fopen('calibrQ_results_h0MLEPhtUpdQ_h0Pest_calls_OS_10_18.tex', 'w');
...
fprintf(FID, '\\toprule \n');
fprintf(FID, '\\multicolumn{10}{c}{{\\bf CALIBRATED PARAMETERS ON WEDNESDAYS, $h_0^Q=ht^P$, THEN 1 WEEK UPDATED UNDER Q}} \\\\\n');
fprintf(FID, '\\midrule \n');
