...
load(strcat('data_MO_IS_', periodstr, '_2010_2018.mat'));
...
%     load(['data for tables/results calibr h0Calibrated esth0P/OptLL/not filtered/GS/params_options_', year_nums{cur_num}, '_h0_calibratedGS_OptLL_interiorpoint_useYield.mat']);
...
FID = fopen(strcat('MO_IS_res_', periodstr, '10_18.tex'), 'w');
