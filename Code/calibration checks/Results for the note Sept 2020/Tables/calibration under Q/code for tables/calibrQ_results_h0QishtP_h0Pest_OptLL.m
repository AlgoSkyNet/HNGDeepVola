clear;
year_nums = {'2010', '2012', '2013'};%, '2014', '2015', '2016', '2017', '2018'};
load('num_weeks');
...
for cur_num = 1:num_years
    load(['data for tables/results calibr hoashtMLEP esthoP/OptLL/not filtered/GS/params_options_', year_nums{cur_num}, '_h0ashtMLEPGS_OptLL_interiorpoint_useYield_m.mat']);
    %load(['data for tables/results calibr hoashtMLEP esthoP/OptLL/filtered/GS/params_options_', year_nums{cur_num}, '_h0ashtMLEPGS_OptLL_interiorpoint_useYield_f.mat']);
