...
for i=1:length(index)
    ...
    sigma2_upd_0(i) = (alpha+omega)/(1-beta-alpha*gamma.^2);
    ...
    [likValQ(i), sigma2_vals] = ll_hng_n(params_Q_mle_weekly(i, :), logret, r, sigma0);
    sigma2_last(i) = sigma2_vals(end);
    
end

% save('weekly_10to18_mle_opt_h0est_check_rng_unCond_Updates.mat','sig2_0','hist_vola', 'opt_ll','sigma2_last',...
