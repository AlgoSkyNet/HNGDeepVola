...
load('weekly_10to18_mle_opt_h0est_rWeekYield_rng_unCond_LikCorrect.mat')
...
%     sig0_unc_tmp    = zeros(53,1);
    ...
    sigma2_upd_0_temp                     = sigma2_upd_0(idx:idx+num_-1);
    ...
    sigma2_updPeriod_0(weeks,:)   = sigma2_upd_0_temp;
    vola_tmp(weeks,:)       = vola;
...
%     end
    name                    = strcat('weekly_',num2str(i+2009),'_mle_opt_h0est_rWeekYield_Unc.mat');
    save(name,'sig_tmp','vola_tmp','params_tmp','sig0_tmp','sig0_unc_tmp','params_tmp_P','logLikVals');%,'rVals')
 clearvars params_tmp params_tmp_P logLikVals sig_tmp sig0_tmp sig0_unc_tmp vola_tmp sigma2_updPeriod_0
end