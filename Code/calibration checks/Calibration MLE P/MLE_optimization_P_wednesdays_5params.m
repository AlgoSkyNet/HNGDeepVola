...
likVal       = NaN*ones(length(index),1);
useYield = 0;
...
for i=1:length(index)
    ...
    [likVal(i)] = ll_hng_n_h0(params_original,logret,r);
end
...
save('weekly_10to18_mle_opt_check.mat','sig2_0','hist_vola','likValall', 'likValmin', 'params_Q_mle_weekly')