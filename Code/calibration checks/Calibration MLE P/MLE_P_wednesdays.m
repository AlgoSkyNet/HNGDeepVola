...
save('weekly_10to18_mle_opt_noh0Est_norEst_rng.mat','sig2_0','hist_vola', 'opt_ll','sigma2_last',...
    'params_Q_mle_weekly','params_P_mle_weekly','r_all')
save('weekly_10to18_mle_opt_noh0Est_norEst_rng_allResSaved.mat')