...
save('weekly_10to18_mle_opt_noh0est_rAv_rng_LikCorrect.mat','sig2_0','hist_vola', 'opt_ll','sigma2_last',...
    'params_Q_mle_weekly','params_P_mle_weekly','date','r_struct', 'sigma2_all')
save('weekly_10to18_mle_opt_noh0est_rAv_rng_LikCorrect_allResSaved.mat')