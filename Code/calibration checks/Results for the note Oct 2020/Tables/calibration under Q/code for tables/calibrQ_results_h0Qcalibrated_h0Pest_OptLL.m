...
FID = fopen('calibrQ_results_h0calAvrGS_h0Pest_calls_OptLL_10_18.tex', 'w');
...
fprintf(FID, '\\toprule \n');
fprintf(FID, '\\multicolumn{10}{c}{{\\bf CALIBRATED PARAMETERS ON WEDNESDAYS, $h_0^Q$ IS CALIBRATED WITH RESPECT TO OPTIONS LIKELIHOOD}} \\\\\n');
fprintf(FID, '\\midrule \n');
