...
load('weekly_10to18_mle_opt_h0est_rAv_rng_unCond_LikCorrect.mat')
...
%     end
    name                    = strcat('weekly_',num2str(i+2009),'_mle_opt_h0est_rAv_Unc.mat');
    save(name,'sig_tmp','vola_tmp','params_tmp','sig0_tmp','sig0_unc_tmp','params_tmp_P','logLikVals','rVals')
 clearvars params_tmp params_tmp_P logLikVals sig_tmp sig0_tmp sig0_unc_tmp vola_tmp rVals
end