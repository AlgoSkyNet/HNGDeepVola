...
if ifHalfYear
    if useMLEPh0
        save('res2013_h0P_6m.mat');
    elseif useUpdatedh0Q
        save('res2013_h0Q_6m.mat');
    elseif useRealVola
        save('res2013_h0RV_6m.mat');
    else
        save('res2012_6m.mat');
    end
else
    if useMLEPh0
        save('res2013_h0P_new.mat');
    elseif useUpdatedh0Q
        save('res2013_h0Q_new.mat');
    elseif useRealVola
        save('res2013_h0RV.mat');
    else
        save('res2013_new.mat');
    end
end