...
for i=1:length(index)
    ...
    if useYield
        ...
        r = SP500_date_prices_returns_realizedvariance_interestRates(5:9, ...
            SP500_date_prices_returns_realizedvariance_interestRates(1,:) ==shortdata(i,1));
        if isempty(r)
...
save('weekly_10to18_mle_opt_h0est_check_rng_unCond.mat','sig2_0','hist_vola', 'opt_ll','sigma2_last',...
    'params_Q_mle_weekly','params_P_mle_weekly')
save('weekly_10to18_mle_opt_h0est_check_rng_unCond_allResSaved.mat')