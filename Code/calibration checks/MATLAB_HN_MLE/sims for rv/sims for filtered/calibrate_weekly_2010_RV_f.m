...
if useMLEPUncondh0
    load(strcat(pathbeg, 'Code/calibration checks/Calibration MLE P/correct Likelihood/Yields/Results with estimated h0P rAv for Update/','weekly_',num2str(year),'_mle_opt_h0est_rAv_Unc.mat'));
else
    load(strcat(pathbeg, 'Code/calibration checks/Calibration MLE P/correct Likelihood/Yields/Results with estimated h0P rAv/','weekly_',num2str(year),'_mle_opt_h0est_rAv.mat'));
end
