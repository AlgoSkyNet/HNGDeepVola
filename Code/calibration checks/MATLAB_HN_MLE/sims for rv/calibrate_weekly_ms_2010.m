   ...
   % [xxval,fval,exitflag] = fmincon(f_min, Init_scale, [], [], [], [], lb, ub, nonlincon_fun, opt);
    ...
    ms = MultiStart('UseParallel', true);    
        options_multistart = optimoptions(@fmincon, 'Algorithm', 'interior-point', ...
                    'TolFun', 1e-15, 'TolX', 1e-15, 'Display', 'iter',  ...
...
elseif useMLEPh0
    ...
    save(strcat('params_options_',num2str(year),'_h0_calibratedfmin_',goal,'_',algorithm,'_',txt,'ms.mat'),'values');
end
%for specific weeks
