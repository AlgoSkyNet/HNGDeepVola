function [fValOut, values]=getCalibratedData(params, weeksprices, data, sig2_0, SP500_date_prices_returns_realizedvariance_interestRates, Dates,dataRet, vola_tmp, index)
