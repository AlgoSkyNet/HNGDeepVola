...
for year_num = 2010:2018
    ...
    load(strcat('/Users/lyudmila/Dropbox/GIT/HenrikAlexJP/Code/calibration checks/MATLAB_HN_MLE/results calibration h0calibarted esth0P OL mp verif/','params_options_',num2str(year_num),'_h0_calibrated_OptLL_interiorpoint_noYield.mat'));
