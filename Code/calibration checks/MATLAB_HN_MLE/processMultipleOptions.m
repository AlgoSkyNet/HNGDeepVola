...
k=1;
for year=2010
load(strcat('res', num2str(year), '_h0calibr_12m_avR_yieldf.mat'));
params = xmin_fmincon;
...
k=1;
for year=[2010]
load(strcat('res', num2str(year), '_h0Q_12m_avR_yieldf.mat'));
params = xmin_fmincon;
...
k=1;
for year=[2010]
load(strcat('res', num2str(year), '_h0RV_12m_avR_yieldf.mat'));
params = xmin_fmincon;
