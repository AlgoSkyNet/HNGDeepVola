...
years           = (dataRet(:,2)==2018);% | (data(:,2)==2011) | (data(:,2)==2012) | (data(:,2)==2013) | (data(:,2)==2014) | (data(:,2)==2015) | (data(:,2)==2016) | (data(:,2)==2017) | (data(:,2)==2018);
...
if ifHalfYear
    if useMLEPh0
        save('res2018_h0P_6m.mat');
    elseif useUpdatedh0Q
        save('res2018_h0Q_6m.mat');
    elseif useRealVola
        save('res2018_h0RV_6m.mat');
    else
        save('res2018_6m.mat');
    end
else
    if useMLEPh0
        save('res2018_h0P_new.mat');
    elseif useUpdatedh0Q
        save('res2018_h0Q_new.mat');
    elseif useRealVola
        save('res2018_h0RV.mat');
    else
        save('res2018_new.mat');
    end
end