...
load("id_8768d7e74d024085_data_vola_norm_43205clean_bigprice");
load("id_8768d7e74d024085_data_price_norm_43205clean_bigprice");
...
for i = 1:Nrun
    ...
    %    end
    %end
    interestRates(interestRates<0) = 0;
    interestRates(isnan(interestRates)) = 0;
    interestRates = repmat(interestRates,1,length(K))';
    % Goal function
...
save('determinisitc_inv_8768d7e74d024085.mat','opt_params_clean','params_analysed','autoencoder_price','autoencoder_vola','volas_analysed','prices_analysed')
%%
load('determinisitc_inv_8768d7e74d024085.mat')
